...
public class TransportLayer implements Loggable {
     ...
     * @param port
     */
    public void forwardPacketToApplication(PacketItem packetItem, int port) {
...
//            icmphandler.sendPortUnreachable(packet.src, packet); // zatim posilat nebudeme, protoze by se nam toho tam posilalo moc
    ...
    /**
     * Unregister application from transport layer. <br /> Application is
    ...
    /**
     * Checks if there is an application is running on given port
     *
     * @param port
     * @return
     */
    public boolean isRunningApp(int port) {
        return applications.containsKey(port);
    }
}
