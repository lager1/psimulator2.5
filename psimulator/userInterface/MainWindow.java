...
import psimulator.logicLayer.Simulator.ServerConnection;
...
import psimulator.userInterface.SaveLoad.SaveLoadManagerUserReactionSimulation;
...
import psimulator.userInterface.SimulatorEditor.SimulatorControllPanel.ConnectToServerDialog;
...
/////////////////////-----------------------------------////////////////////
            ...
            switch (UserInterfaceMainPanelState.valueOf(e.getActionCommand())) {
                ...
                case SIMULATOR:
                    ...
                    if(!dataLayer.getSimulatorManager().hasAllEventsItsComponentsInModel()){
                        ...
                        if(result == 0){    // save events and clear list
                            //System.out.println("save events and clear list");
                            // save events
    ...
    private void lowPermissionNotice() {
            ...
            this,
            dataLayer.getString("LOW_PERMISSION"),
            dataLayer.getString("WARNING"),
            JOptionPane.YES_NO_OPTION,
            JOptionPane.INFORMATION_MESSAGE,
            null, //do not use a custom Icon
...
//            }
 ...
 //           System.out.println("spusteno bez admina");
     ...
     * @return
     */
    private boolean checkDataLossBeforeSimulation() {
        // if data can be lost
        if (saveLoadManagerGraph.doCheckIfPossibleDataLoss(jPanelUserInterfaceMain.getGraph()) || (saveLoadManagerGraph.getFile() == null)) {

            SaveLoadManagerUserReactionSimulation userReaction = saveLoadManagerGraph.doAskUserIfSaveBeforeSimulation(jPanelUserInterfaceMain.getGraph());
...
////////------------ PRIVATE------------///////////
    ...
    private void addActionListenersToViewComponents() {
        ...
        ActionListener serverLogListener = new JToolBarServerLog();
        jToolBar.addServerLogActionListener(serverLogListener);
        // END add listeners to ToolBar - SIMULATION
    }
