 ...
 * created 29.2.2012
 */
package dataStructures.packets.L3;

import dataStructures.packets.L4Packet;
import shared.SimulatorEvents.SerializedComponents.PacketType;
import utils.Utilities;

import static dataStructures.packets.L3.IcmpPacket.Type.*;
import static dataStructures.packets.L3.IcmpPacket.Code.*;
...
// Enums for type and code (witch converting functions): ------------------------------------------------------------
    ...
    public static Code intToCodeEnum(int t) throws Exception {
        switch (t) {
            ...
            case 4:
                return FRAGMENTAION_REQUIRED;
            case 6:
                return DESTINATION_NETWORK_UNKNOWN;
        }
