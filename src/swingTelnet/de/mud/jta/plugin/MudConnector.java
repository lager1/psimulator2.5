...
public class MudConnector
  ...
  protected int step;
  protected Map<String, Object[]> mudList = null;
  protected JList<Object> mudListSelector = new JList<Object>();
  ...
  public void run() {
    try {
      ...
      Map<String, JMenu> menuList = new HashMap<String, JMenu>();

      mudList = new HashMap<String, Object[]>();
      BufferedReader r =
      ...
      List<String> list = new ArrayList<String>(mudList.keySet());
