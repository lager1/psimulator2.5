 ...
 *
 * Parser si bude muset pamatovat posledni spusteny prikaz, aby kdyz dostane
 * signal SIG_INT, aby dokazal poslat prikaz vypnuti posledni spustene
 * aplikace/prikazu.
 *
 * @author neiss
 */
public abstract class AbstractCommandParser {
    ...
    /**
     * Slouzi k predavani uzivatelskyho vstupu prave spustenymu prikazu (kdyz se
     * ten prikaz napr. na neco pta.
     * @param userInput 
     */
    ...
    /**
     * Jednoducha metoda pro vypsani pouzitelnejch prikazu. Slouzi k
     * jednoduchemu napovidani.
     *
     * @param mode aktuali mod toho shellu (pro cisco)
     * @return
     */
