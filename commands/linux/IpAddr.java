...
public class IpAddr extends LinuxCommand {
    ...
    protected void vykonejPrikaz() {
        ...
        if (navrKod != 0 && navrKod != Utilities.md(10)) {
        ...
        if (akce == 2 || akce == 3) {
            ...
            if (adresa == null) {
                ...
                try {
                    ...
                    navrKod |= Utilities.md(1); // opravdu je uplne jedno, co je spatne...
                }
            }
            //kontrola rozhrani:
            if (rozhrRet == null) {
    ...
    private void vypisChybovyHlaseni() {
        if (enableDebug) printLine(toString());
        ...
        if ((navrKod & Utilities.md(1)) != 0) { //spatna adresa
        ...
        if ((navrKod & Utilities.md(5)) != 0) { //nezadano rozhrani, kdyz by melo
            printLine("Not enough information: \"dev\" argument is required.");
            return;
        }
        if ((navrKod & Utilities.md(10)) != 0) { //u mazani nezadana maska
        ...
        if ((navrKod & Utilities.md(3)) != 0) { // neexistujici rozhrani
            if (akce == 2 || akce == 3) {
        ...
        if ((navrKod & Utilities.md(4)) != 0) { // u akce add nebo del nezadana adresa
            if (akce == 2) {
        ...
        if ((navrKod & Utilities.md(8)) != 0) { // na rozhrani je stejna adresa
            printLine("RTNETLINK answers: File exists");
            return;
        }
        if ((navrKod & Utilities.md(7)) != 0) { // na rozhrani existuje jina adresa
        ...
        if ((navrKod & Utilities.md(9)) != 0) { // mazana adresa neexistuje
            printLine("RTNETLINK answers: Cannot assign requested address");
            return;
        }
    }
